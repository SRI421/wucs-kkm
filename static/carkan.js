...
car = car.replace(/0/g, "0");
car = car.replace(/1/g, "1");
car = car.replace(/2/g, "2");
car = car.replace(/3/g, "3");
car = car.replace(/4/g, "4");
car = car.replace(/5/g, "5");
car = car.replace(/6/g, "6");
car = car.replace(/7/g, "7");
car = car.replace(/8/g, "8");
car = car.replace(/9/g, "9");
